-- Fix Transactions RLS Policies - Complete
-- =========================================
-- Run this in Supabase SQL Editor to ensure transactions work correctly

-- Drop all existing policies
DROP POLICY IF EXISTS "Employees can view own transactions" ON transactions;
DROP POLICY IF EXISTS "Employees can insert own transactions" ON transactions;
...
-- Admins can insert transactions (for direct wallet deductions)
